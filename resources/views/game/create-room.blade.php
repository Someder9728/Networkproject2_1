...
<head>
    ...
    <title>Ware Woof - Create Room</title>
    ...
    <main class="w-100" style="max-width: 672px;">
        ...
        <div class="text-center mb-5">
            <h1 class="display-5 fw-black letter-spacing-widest text-uppercase fw-bold">
                CREATE <span style="color: #a855f7;">ROOM</span>
            </h1>

            <p class="mt-3 text-secondary">
                ตั้งค่าห้องสำหรับเกม Ware Woof
            </p>
        </div>
        ...
        <div class="custom-card p-4 p-md-5">
            ...
            <div class="mb-4">
                ...
                <input id="roomName" type="text" placeholder="เช่น Ware Woof Room"
            ...
            <div class="mb-4">
                ...
                <select id="playerCount" class="form-select form-select-custom">
            ...
            <div class="mb-5">
                <label for="werewolfCount" class="form-label">
                    จำนวน Werewolf
                </label>

                <select id="werewolfCount" class="form-select form-select-custom">
                    <option value="1">1 Werewolf</option>
                    <option value="2">2 Werewolves</option>
                </select>
            </div>

            <div class="row g-3">
                <div class="col-6">
                    <a href="/lobby" class="btn btn-back w-100">
                        Back
                    </a>
                </div>

                <div class="col-6">
                    <button id="createRoomBtn" type="button" class="btn btn-create w-100">
                        Create Room
                    </button>
                </div>
            </div>
